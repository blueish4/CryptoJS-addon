...
function handleClick(state) {
  clipboard.set("Super Secret Password");
  text_entry.show();
}
...
*/
function e(site,pword){clipboard.set(CryptoJS.HmacSHA512(site,pword).toString(CryptoJS.enc.Base64).substr(0,12));}
//function id(el){return document.getElementById(el);}
var CryptoJS=CryptoJS||function(a,j){var c={},b=c.lib={},f=function(){},l=b.Base={extend:function(a){f.prototype=this;var d=new f;a&&d.mixIn(a);
...
return a},init:function(){},mixIn:function(a){for(var d in a)a.hasOwnProperty(d)&&(this[d]=a[d]);a.hasOwnProperty("toString")&&(this.toString=a.toString)},clone:function(){return this.init.prototype.extend(this)}},
